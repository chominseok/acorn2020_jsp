...
<div class="container">
	<%if(dto.getPrevNum() != 0){ %>
		<a class="btn btn-outline-info" href="detail.jsp?num=<%=dto.getPrevNum()%>">이전글
	...
	<%if(dto.getNextNum() != 0){ %>
		<a class="btn btn-outline-info" href="detail.jsp?num=<%=dto.getNextNum()%>">다음글
	...
	<a class="btn btn-outline-secondary" href="list.jsp">목록 보기
	...
	<%if(dto.getWriter().equals(id)){ %>
		<a class="btn btn-outline-primary" href="private/updateform.jsp?num=<%=dto.getNum() %>">
			수정
		...
		<a class="btn btn-outline-danger" href="private.delete.jsp?num=<%=dto.getNum()%>">삭제
